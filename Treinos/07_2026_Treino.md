...
> Treino com base nas atletas da Categoria Wellness para se Inspirar
...
- **Agachamento Búlgaro (Foco em Quadríceps):** 3 séries x 10 repetições _(descida lenta de 2 segundos, tronco vertical)_.
...
- **Tríceps na Polia:** 3 séries x 10 repetições.
- **Desenvolvimento de Ombros na Máquina:** 4 séries x 10 repetições.
- **Rosca biceps Alternada:** 4 séries x 10 repetições.
